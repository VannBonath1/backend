...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/v1/users/GetAllUsers/:sortOption',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    sortOption: {"in":"path","name":"sortOption","required":true,"dataType":"string"},
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/v1/users/GetUserById/:userId',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.put('/v1/users/updateUserById/:userId',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/v1/users/GetUserByAgeRange',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.getUserByAgeRange)),

            async function UserController_getUserByAgeRange(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    minAgeRange: {"in":"query","name":"minAgeRange","required":true,"dataType":"double"},
                    maxAgeRange: {"in":"query","name":"maxAgeRange","required":true,"dataType":"double"},
            };
